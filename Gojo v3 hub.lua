...
Visuals_Page2:Toggle("Auto Click",false,function(value)
 _G.click = value
end)

Visuals_Page2:Toggle("SuperFast Attack มีโอกาสโดนเตะออกจากเซิฟ ",_G.FastAttackNormalSpeed,function(value)
...
Visuals_Page2:Toggle("Auto Click2",false,function(value)
	_G.click = value
end)
...
Visuals_Page2:Toggle("AntiAFK",true,function(value)
	_G.AFK = value
end)
